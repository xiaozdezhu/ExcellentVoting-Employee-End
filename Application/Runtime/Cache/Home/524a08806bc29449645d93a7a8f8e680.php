...
<!-- ngView:  --><div ng-view="" class="route"><div class="container-full" ng-controller="mainCtrl" style="position: relative">
    ...
    <div class="login-panel">
        <div class=" form-width" style="height: 3px">
            <div id="loginBtn" class="left rg-title cursor-pointer" ng-class="{&#39;rg-title-selected&#39;:model.isLogin}" ng-click="change(true)"><a href="login.html">登录</a></div>
            <div id="regBtn" class="rg-title right rg-title-selected" ng-class="{&#39;rg-title-selected&#39;:!model.isLogin}" ng-click="change(false)"><a href="register.html">注册</a></div>
            <div class="register-underline" ng-style="!model.isLogin&amp;&amp;{&#39;margin-right&#39;:220}"></div>
        </div>


        <!-- ngIf: !model.isLogin -->
        <div ng-if="!model.isLogin" ng-controller="registerCtrl" ng-enter="register()" class="">
            <form class="ng-pristine ng-valid ng-valid-maxlength" action="/vote-fe/index.php/Login/register.html" method="post">
                <div style="margin-top: 30px" class="reg-form">
                    <div><input type="text" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="rgUser.username" placeholder="请设置用户名" ng-mouseleave="checkSuperId(true)" ng-blur="checkSuperId(true)" name="username">
                        <div ng-show="!validUname" class="error-tag ng-hide"></div>
                    </div>
                </div>
                <div style="margin-top: 0px" class="reg-form">
                    <div><input type="text" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="rgUser.username" placeholder="请输入真实姓名" ng-mouseleave="checkSuperId(true)" ng-blur="checkSuperId(true)" name="realname">
                        <div ng-show="!validUname" class="error-tag ng-hide"></div>
                    </div>
                </div>
                <div class="reg-form">
                    <div><input type="password" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="rgUser.password" ng-blur="checkPassword(true)" placeholder="密码( 6-32位 )" name="password">
                        <div ng-show="!validPwd" class="error-tag ng-hide"></div>
                    </div>
                </div>
                <div class="reg-form">
                    <div><input type="password" class="rg-input ng-pristine ng-untouched ng-valid" ng-model="rgUser.rePassword" ng-blur="confirmPassword(true)" placeholder="再次输入密码" name="repassword">
                        <div ng-show="!validRepwd" class="error-tag ng-hide"></div>
                    </div>
                </div>
                <div class="reg-form">
                    <div><input type="text" valid-name="" ng-maxlength="13" ng-trim="true" class="rg-input ng-pristine ng-untouched ng-valid ng-valid-maxlength" ng-model="rgUser.nickName" ng-blur="confirmNickName(true)" placeholder="请输入部门ID" name="departmentId">
                        <div ng-show="!validNickName" class="error-tag ng-hide"></div>
                    </div>
                </div>

                <button type="submit" class="rg-btn" style="margin-top: 20px" ng-class="register_ing?&#39;rg-btn-click&#39;:&#39;&#39;" ng-click="register()" ng-bind="register_ing?&#39;注册SuperID...&#39;:&#39;注册SuperID&#39;">注册SuperID</button>
            </form>
