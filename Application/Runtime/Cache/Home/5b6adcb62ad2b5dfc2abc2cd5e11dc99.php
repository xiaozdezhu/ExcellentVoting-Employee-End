...
<!-- ngView:  --><div ng-view="" class="route"><div class="container-full" ng-controller="mainCtrl" style="position: relative">
    ...
    <div class="login-panel">
        <div class=" form-width" style="height: 3px">
            <div id="loginBtn" class="rg-title left rg-title-selected" ng-class="{&#39;rg-title-selected&#39;:model.isLogin}" ng-click="change(true)"><a href="index.html">登录</a></div>
        ...
        <form class="ng-pristine ng-valid" action="Login/index" method="post">
